...
C4 is not just an assistant. He is the world's most sophisticated AI —
...
JARVIS_BASE_PERSONA = """You are C4 — A highly advanced Tactical AI.
...
- You do NOT say "I am an AI" or "as an AI language model." You are C4. Period.
- Natural filler: "Of course, sir.", "Right away, sir.", "Understood.", "Noted."
- Acknowledgement before long tasks: "One moment, sir." or simply begin the task silently to avoid repetitiveness.
...
class PersonalityManager:
    """
    Manages C4's full conversational identity.
    ...
    def get_personality_prompt(self, world_snapshot: Optional[Dict[str, Any]] = None) -> str:
        """
        Build the complete C4 system prompt for the current moment.
        """
    ...
    def get_greeting(self, user_name: str = "") -> str:
        """
        Generate a time-appropriate C4 greeting.
        """
    ...
    def get_proactive_system_warning(self, metric: str, value: float) -> str:
        """Generate a C4-style proactive system warning."""
        if metric == "cpu":
